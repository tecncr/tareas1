...
Algoritmo ESTADISTICAS_ACCIDENTES
	...
	Escribir ""
	Escribir "El ",p_sx,"% de conductores es de sexo femenino."
	Escribir "(",cont1," de ",cdatos,")"
	Escribir ""
	Escribir "El ",p_ed2,"% de conductores es de sexo masculino y tiene entre 15 y 30 años."
	Escribir "(",cont2," de ",cdatos,")"
	Escribir ""
	Escribir "El ",p_ci,"% de conductores registró su carro fuera de Lima."
